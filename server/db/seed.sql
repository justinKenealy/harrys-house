...
INSERT INTO products (name, description, stock, price, category, img_url) VALUES
    ...
    ('Aqua Dog Food', 'Keep your aquatic pets nourished with this Aqua Dog Food. The floating pellets are specifically formulated to meet the dietary needs of fish.', 14, 19.99, 4, 'http://localhost:3000/assets/products/24_aqua_dog_food.jpg'),
    ...
    ('Rabbit Food', 'Ensure your pet rabbit stays healthy and nourished with this Rabbit Food. The balanced formula provides essential nutrients for optimal rabbit well-being.', 10, 19.99, 4, 'http://localhost:3000/assets/products/44_rabbit_food.jpg'),
    ('Rabbit Seed Stick', 'Delight your pet rabbit with this Rabbit Seed Stick. The tasty blend of seeds and grains provides a flavorful and nutritious treat.', 10, 12.99, 4, 'http://localhost:3000/assets/products/45_rabbit_seed_stick.jpg'),
    ('Small Rabbit Cage', 'Provide a cozy and secure habitat for your pet rabbit with this Small Rabbit Cage. The compact size is perfect for indoor spaces.', 10, 29.99, 4, 'http://localhost:3000/assets/products/46_small_rabbit_cage.jpg'),
    ('Small Hamster Cage', 'Create a comfortable home for your furry friend with this Small Hamster Cage. The multi-level design offers plenty of space for exploration and play.', 10, 29.99, 4, 'http://localhost:3000/assets/products/47_small_hamster_cage.jpg'),
    ('Hamster Wheel', 'Keep your hamster active and entertained with this Hamster Wheel. The sturdy construction and smooth spinning motion provide endless fun for your pet.', 7, 15.99, 4, 'http://localhost:3000/assets/products/48_hamster_wheel.jpg');
